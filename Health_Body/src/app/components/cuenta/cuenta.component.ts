...
@Component({
    ...
    imports: [MatSidenavModule, RouterLink, MatButtonModule, MatCardModule, MatInputModule, MatFormFieldModule, FormsModule, IconFieldModule, InputIconModule, AvisoComponent]
})
